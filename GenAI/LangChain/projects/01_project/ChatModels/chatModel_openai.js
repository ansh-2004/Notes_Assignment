...
// maxTokens : it is use to limit the number of tokens in the response , if you want more detailed response then you can set maxCompletionTokens to 1000 or 2000 , if you want more concise response then you can set maxCompletionTokens to 100 or 200
