...
- This is a security group issue. Any timeout (not just for SSH) is related to security groups or a firewall. Ensure your security group allow SSH PORT 22 , source anywhere (0.0.0.0/0) and correctly assigned to your EC2 instance.
...
- Follow again the steps. If things don't work,  use EC2 Instance Connect 
